...
video_path   = "./IMAGES/" # put random video in folder

yolo = Load_Yolo_model()
detect_image(yolo, image_path, "./IMAGES/street_pred.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
